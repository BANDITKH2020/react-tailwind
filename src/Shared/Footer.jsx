...
const Footer =  () => {
    return (
        <div className="bg-[#010851] md:px-14 p-4 max-w-screen-2xl mx-auto text-white">
            ...
            <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-8 my-8'>
                ...
                <div className='flex items-center space-x-5'>
                    ...
                    <img src={instragram} alt="" className='w-8 cursor-pointer hover:-translate-y-4 transition-all duration-300'/>
